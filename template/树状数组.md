...
[LC315.计算右侧小于当前元素的个数](https://leetcode.cn/problems/count-of-smaller-numbers-after-self/description/)
...
[LC327.区间和个数](https://leetcode.cn/problems/count-of-range-sum/)
...
[LC2736.最大和查询](https://leetcode.cn/problems/maximum-sum-queries/)
...
参考[链接](https://oi-wiki.org/ds/fenwick/#%E5%8D%95%E7%82%B9%E4%BF%AE%E6%94%B9%E6%9F%A5%E8%AF%A2%E5%85%A8%E5%B1%80%E7%AC%AC-k-%E5%B0%8F)

思想是一步步确定答案的每个二进制位，从 $log\ n$ 开始跳到 $0$，先查询区间和，如果小于 $k$，则可确定这一位。最后得到满足 $[1..x]$ 前缀和小于 $k$ 的最大值，那么 $x+1$ 就是答案
